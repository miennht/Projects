...
public class MathCaptcha extends Captcha {
    ...
    public MathCaptcha(int width, int height, MathOptions opt){
        ...
        setWidth(width);
        this.options = opt;
        Captcha.usedColors = new ArrayList<Integer>();
        this.image = image();
    }
    ...
    protected Bitmap image() {
        ...
        LinearGradient gradient = new LinearGradient(0, 0, getWidth() / 2, this.height / 2, Captcha.color(), Captcha.color(), Shader.TileMode.MIRROR);
        Paint p = new Paint();
        p.setDither(true);
        ...
        LinearGradient fontGrad = new LinearGradient(0, 0, getWidth() / 2, this.height / 2, Captcha.color(), Captcha.color(), Shader.TileMode.CLAMP);
        Paint tp = new Paint();
        tp.setDither(true);
